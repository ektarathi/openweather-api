...
import HourlyReport from "../../components/hourly-report";
...
const HourlyWeather = () => {
	...
	return (
		<div className="container">
			...
			<Header />
			<main>
				<h1 className="text-center">Hourly Weather Forecast</h1>
				...
				<div className="grid">
					{weather.length !== undefined ? "" : <HourlyReport data={weather} />}
				</div>
			</main>
			<Footer />
		</div>
